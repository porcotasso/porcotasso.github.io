...
*/ ?>
    ...
    <div class="homeProfile">
        ...
        <div class="homeSkill">
            ...
            <ul>
                <li>    
                    <h5 class="js-popupTrigger" data-popup="コンテンツ・モデルに従ったコーディングをする。<br>セマンティックHTMLの重要性の理解。Nodeの概要把握">html</h5>
                </li>
                <li>
                    <h5 class="js-popupTrigger" data-popup="リセットCSS•ノーマライズ CSSの理解。<br>スタイルのカテゴライズを意識する。スコープの意図的な指定や命名ルールでカオスにならないようなルール作りを心がける。">scss</h5>
                </li>
                <li>
                    <h5>javascript</h5>
