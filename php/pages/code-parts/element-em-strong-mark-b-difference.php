...
<main class="ly-baseWrap ly-UnderheaderSpace"> 
    <article class="articleCnt">
        ...
        <section class="ly-section" id="2">
            <h2>strongタグ</h2>
            <p>strongタグは、強い重要性、深刻性、緊急性を表し大事な部分を強調するときに使います。前述のemタグは、文の意味が変更されるのに対して、strongタグは、文の意味が変更されません。emタグ、bタグより強い重要性を示します。HTML4.01からHTML5に移行で廃止されると言及もありましたが、そのまま使われています。特定のキーワードだけstrongタグを乱用するといった不適切な使用を繰り返せば、ペナルティのリスクを高める原因にもなりかねません。</p>
        </section>
        <section class="ly-section" id="3">
            <h2>markタグ</h2>
            <p>重要性とは関係なく注目させたい場合に使用します。検索結果をハイライトしたいときにも使えます。</p>
        </section>
        <section class="ly-section" id="4">
            <h2>bタグ</h2>
            <p>目立たせたいけど、emタグ、strongタグ、markタグ、iタグではないと思ったときに最後の手段で使用します。見栄えを定義するタグとして、HTML4.01 では「非推奨(deprecated)」とされましたが、HTML5 では「特に付加的な重要性を与えるわけでも、異なるトーンや雰囲気を表現するわけでもないが、実利的な理由から注意を引きつける箇所」を示すタグとして、非推奨が解除されており、b は「太字」と理解するのは間違いのようです。単に太字にしたいのならfont-weightを使用すべきだそう。</p>
        </section>
        <section class="ly-section" id="5">
            <h2>dfnタグ</h2>
            <p>definitionの略で、用語の意味を定義する際に使用します。定義用語が何度も出る場合には最初の用語だけdfnタグで囲むのが一般的ですがあまり使用されていません。</p>
        </section>
        <section class="ly-section" id="6">
            <h2>iタグ</h2>
            <p>iタグを使用すると文字が斜めに表現されますが、イタリック体、斜体、標準フォントを強引に傾斜の３つパターンがあります。指定フォントにイタリック体があればイタリック体、ない場合は斜体、イタリック体も斜体もなければ標準フォントを斜めにして表示されます。日本語フォントの多くは標準フォントを斜めに傾けた表示になります。iタグ使用は非推奨ではないですができるだけスタイルシート<code>{font-style:italic;}</code>で指定しましょう。
            </p>
        </section>
