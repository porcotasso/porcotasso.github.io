...
function handleTouchMove(e) {
  ...
  if (scroll <= 0) {
      ...
      elem.scrollTop = range;
			...
			<h3>現状</h3>
			<p>bodyにpreventDefault()をつけるとメニューもスクロールがとまってしまい、また背景（mainなど）につけると、そもそもイベントが反応しないので、とりあえずpreventDefault()ははずしておく。style.overflow = 'hidden';でandoroid の対応だけしておく。</p>
